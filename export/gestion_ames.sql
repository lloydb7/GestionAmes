...
CREATE TABLE `entretiens` (
  ...
  `numero_entretien` int(11) NOT NULL DEFAULT 1,
...
CREATE TABLE `famille_impacts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nom` varchar(255) NOT NULL,
  `pilote1_nom` varchar(255) NOT NULL,
  `pilote1_tel` varchar(255) NOT NULL,
  `pilote2_nom` varchar(255) DEFAULT NULL,
  `pilote2_tel` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `suivis`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_suivis_ame` (`ame_id`),
  ADD KEY `fk_suivis_user` (`user_id`);
...
--
ALTER TABLE `ames`
  ADD CONSTRAINT `fk_ames_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `entretiens`
--
ALTER TABLE `entretiens`
  ADD CONSTRAINT `entretiens_ibfk_1` FOREIGN KEY (`ame_id`) REFERENCES `ames` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `entretiens_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `suivis`
--
ALTER TABLE `suivis`
  ADD CONSTRAINT `fk_suivis_ame` FOREIGN KEY (`ame_id`) REFERENCES `ames` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_suivis_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
